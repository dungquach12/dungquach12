...
- Design and train a VGG-based CNN for 7-class facial expression classification using TensorFlow and OpenCV.
- Using regularization techniques and data augmentation to handle noise and in real-time video feeds.
- Achieved good performance on the FER-2013 dataset while maintaining a lightweight architecture.
